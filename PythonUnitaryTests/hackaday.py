...
print 'Total profile followers: ' + str(HDproffollowers)
print 'Total likes: ' + str(HDlikes)
print 'Total views: ' + str(HDviews)
print 'Total projects followers: ' + str(HDprojfollowers)
print 'Total comments: ' + str(HDcomments)
