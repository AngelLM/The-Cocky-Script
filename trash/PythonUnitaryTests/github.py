...
print 'Total followers: ' + str(GHfollowers)
print 'Total watchers: ' + str(GHwatchers)
print 'Total stars: ' + str(GHstars)
print 'Total forks: ' + str(GHforks)
print 'Total contributors: ' +str(GHcontributors)
